...
sys.path.append('dependencies/quanser')
...
from dependency.utils import init_qcar
...
front_csi = Camera2D(camera_id="0@tcpip://localhost:18964", # currently, id of other cameras are unknown, f: 3
...
while True: 
    try: 
        ...
        my_car.read_write_std(np.array([0.05, steering]), LEDs)
